...
Данный репозиторий содержит материалы с лекций и практик.

Остальные материалы могут быть найдены по нижеприведённым ссылкам.
...
- [Пример выполнения](https://github.com/itsecd/oop-demo)
