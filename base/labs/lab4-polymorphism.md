...
16. (*) Персонажи компьютерной игры `Character` (командное PvE).
    - Классы-наследники:
      ...
      - NPC:
        - допускается NPC сделать не самостоятельным классом, а промежуточным базовым классом,
          от которого унаследовать более конкретные классы NPC (скажем, условно, "адская гончая" и "приспешник тьмы").
    - Состояние:
      - количество очков жизни:
      ...
      - только для "NPC":
        - текущий уровень угрозы для каждого игрока:
          ...
          - если "лекарь" лечит любого игрока, то уровень угрозы "лекаря" увеличивается.
    - Переопределяемые методы:
      - рассчитать наносимый урон;
      - принять урон;
    ...
    - В `main` создать две команды.
      ...
      - При моделировании поведение игроков должно быть адекватным,
        ...
        Кроме того, в идеале (но не обязательно) все игроки должны концентрировать урон на одной цели.
      - Каждый NPC всегда атакует того игрока, который имеет наибольший уровень угрозы для этого NPC.
        Если у NPC есть способности, они могут применяться случайным образом.
    - Все конкретные числовые значения величин (игровой баланс) подбирать самостоятельно.
    - Для способностей следует завести отдельную иерархиж классов.
...
2. Разработайте пошаговую RPG-игру:
   ...
   Умения игроков должны управляться с клавиатуры или мыши.
